        ...
        <div class="contenedor1">
            <div class="contenedor-texto">
                ...
                <div class="texto-noticia">
                    <h1>El Salvador da un gran paso en la industria del diseño: nace el Instituto Internacional de Moda Haute Couture</h1>
                </div>
                <div class="footer-new">
                    <h5><span>LAINT</span> Enero 10, 2025, 9:58am</h5>
                </div>
            </div>
            ...
            <div class="contenedor-notis">
                ...
                <div class="contenedor-noti-uno">
                    <div class="texto-noti">
                        <h5><strong>Tema: </strong>Moda</h5>
                        <h5 class="autor"><strong>Autor:</strong>LAINT</h5>
                        <h3><a href="../Maqueta/culturaNoticia3.php"><strong>Instituto de moda en El Salvador</strong></a></h3>
                    </div>
                    <div class="contenedor-img">
