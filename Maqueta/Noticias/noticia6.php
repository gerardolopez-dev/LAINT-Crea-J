...
<body>
                ...
                <div class="contenedor-notis">
                    <div class="contenedor-noti-uno">
                        <div class="texto-noti">
                            ...
                            <h3><a href="../Noticias/noticia1.html"><strong>Miles celebraran el dia del Skateboarding</strong></a></h3>
                        </div>
    ...
    <div class="grid-language">
        <div class="language"><a href="../../Maqueta EN/Noticias/noticia6.php">+ English</a></div>
    </div>
