        ...
        <div class="contenedor1">
            <div class="contenedor-texto">
                ...
                <div class="footer-new">
                    <h5><span>LAINT</span> January 10, 2025, 9:58am</h5>
                </div>
            </div>
...
<aside class="masDeLoMismo">
        ...
        <div class="contenedor-notis">
            <div class="contenedor-noti-uno">
                <div class="texto-noti">
                    ...
                    <h5 class="autor"><strong>Author:</strong>LAINT</h5>
                    <h3><a href="../Maqueta EN/culturaNoticia2.php"><strong>Salvadoran Designers with International Presence</strong></a></h3>
                </div>
            ...
            <div class="contenedor-noti-uno">
                <div class="texto-noti">
                    <h5><strong>Topic: </strong>Fashion</h5>
                    <h5 class="autor"><strong>Author:</strong>LAINT</h5>
                    <h3><a href="../Maqueta EN/culturaNoticia3.php"><strong>Fashion Institute in El Salvador</strong></a></h3>
                </div>
                <div class="contenedor-img">
    ...
    <div class="grid-language">
        <div class="language"><a href="../Maqueta/culturaNoticia1.php">+ Español</a></div>
    </div>
